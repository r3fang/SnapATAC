...
$ R
> library(SnapATAC);
> x.sp = createSnap("atac_v1_pbmc_10k.snap", sample="atac_v1_pbmc_10k", num.cores=1);
...
> summarySnap(x.sp)
Total  number of barcodes: 9044
Median number of sequencing fragments: 19660
Median number of uniquely mapped fragments: 9861.5
...
Median number of unique molecules (UMI): 9861.5
```
