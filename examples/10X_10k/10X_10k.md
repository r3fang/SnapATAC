...
UMAP    
<img src="./gene_plot_umap.png" width="800" height="600" />


**Step 19. Create cell-by-peak matrix (snaptools)**.        

```bash
$ wget http://cf.10xgenomics.com/samples/cell-atac/1.0.1/atac_v1_pbmc_10k/atac_v1_pbmc_10k_peaks.bed
$ snaptools snap-add-pmat  \
	--snap-file=atac_v1_pbmc_10k.snap  \
	--peak-file=atac_v1_pbmc_10k_peaks.bed
```
